 ...
 */
public final class JdkUnicodeProvider implements UnicodeProvider{

  @Override
  public String idnaNameToASCII(final CharSequence name) {
    return IDN.toASCII(name.toString());
  }

  @Override
  public String idnaNameToUnicode(final CharSequence name) {
